  ...
  expandArticle() {
    // Using our reference to the domElement, toggle a class to expand or hide the article.
      ...
      if (this.expandButton.textContent === 'Mark As Read') {
        this.expandButton.addEventListener('click', () => this.read());
    }
  }
...
- With your selection in place, now chain
.forEach() on to the articles variable to iterate
over the articles NodeList and create a
new instance of Article by passing in
